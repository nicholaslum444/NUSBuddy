...
public class CapCalculator extends BaseActivity {
	...
	public Spinner createModuleCreditsSpinner() {
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Credits, android.R.layout.simple_list_item_1);
	...
	public Spinner createModuleGradeSpinner() {
		...
		// insert the mc values into the spinner
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Grade, android.R.layout.simple_list_item_1);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
